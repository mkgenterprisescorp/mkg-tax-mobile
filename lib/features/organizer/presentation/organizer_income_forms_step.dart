            ...
            MkgCard(
              child: Column(
                ...
                children: [
                  ...
                  OrganizerTextField(label: 'Employer address', value: '${rows[i]['employerAddress'] ?? ''}', onChanged: (v) => _patchRow(key, i, 'employerAddress', v)),
                  OrganizerTextField(label: 'Employer city', value: '${rows[i]['employerCity'] ?? ''}', onChanged: (v) => _patchRow(key, i, 'employerCity', v)),
                  _stateField(key, i, 'employerState', rows[i]),
                  OrganizerTextField(label: 'Employer ZIP', value: '${rows[i]['employerZip'] ?? ''}', onChanged: (v) => _patchRow(key, i, 'employerZip', v)),
            ...
            MkgCard(
              child: Column(
                children: [
                  ...
                  OrganizerTextField(label: 'Payer address', value: '${rows[i]['payerAddress'] ?? ''}', onChanged: (v) => _patchRow(key, i, 'payerAddress', v)),
